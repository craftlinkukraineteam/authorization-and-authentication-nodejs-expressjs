...
Невеликий backend‑застосунок, створений на Node.js, який відповідає за реєстрацію та автентифікацію користовучів у системі.
Застосунок взаємодіє з frontend‑застосунком (Next.js) через REST API та використовує JWT (JSON Web Token) для аутентифікації.
